************************************************************************
*
*     Subroutine AMLREG            Called by: AMLLOAD2, CALIBR, ESTCAL
*
...
*
************************************************************************
      SUBROUTINE AMLREG(NOBSC,NPAR,XLCAL,YLCAL,YD,CENSFLAG,XLIKE,STDDEV,
...
*
 ...
 20   CONTINUE
      ...
      CALL TACIT_R(NOBSC,NPAR,YLCAL,YD,X,PARMLE,XLIKE,CENSFLAG,NOBSCI)
 ...
 50   CONTINUE
      ...
      DO 100 I=1,NOBSC
         CALL TACIT_D((YD(I)-PRED(NPAR,NOBSCI,I,X,PARMLE))
...
*     invert matrices
*
      CALL MATINV(NPAR+1,H2,CV)
      CALL MATINV(NPAR+1,SH2,SCV)
