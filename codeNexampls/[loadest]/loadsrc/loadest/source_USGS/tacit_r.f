...
*
      LOGICAL CENSFLAG(*)
      INTEGER*4 NOBSC,NPAR,NOBSCI
      DOUBLE PRECISION XLIKE,YLCAL(*),YD(*),PARMLE(*),X(NOBSCI,*)
*
*     local vars
*
      INTEGER*4 I
...
*     
*
      CALL DHUMSL(CENSFLAG,D,IV,LV,NOBSC,NOBSCI,NPAR,PARMLE,V,X,YD,
     &            YLCAL)
      CALL TACIT_L(PARMLE,XLIKE,NOBSC,NPAR,X,YLCAL,YD,CENSFLAG,NOBSCI)
